...
There are two kinds of components for RedwoodJS

  * **Components** do not require a GraphQL query and state.
  * **Cells** do require a GraphQL query and state.

## Component

Components are a way to define reusable components that can be used in multiple places in your application.  
## Cell

From the RedwoodJS docs:
...
Done in 1.07s.
```
I've been moving these files in the Models they belong to after creation.
